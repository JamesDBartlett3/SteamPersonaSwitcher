...
/// <summary>
/// Custom Steam authenticator that logs messages to debug panel instead of showing GUI prompts
...
public class GuiSteamAuthenticator : IAuthenticator
{
    public Task<string> GetDeviceCodeAsync(bool previousCodeWasIncorrect)
    {
        ...
        DebugLogger.Instance.Warning($"[STEAM GUARD] {message}");
    ...
    {
        DebugLogger.Instance.Info("[STEAM GUARD] 📱 Please confirm this login in your Steam Mobile App.");
        DebugLogger.Instance.Info("[STEAM GUARD] Waiting for mobile confirmation...");
